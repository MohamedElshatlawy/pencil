...
public class instsignup extends Fragment {
    Button button;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_instsignup, container, false);
        ...
        radioGroup=view.findViewById(R.id.radioGrpIns);
        ...
        //String flag = details.getString("flag", "this member is not specified");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                networkcalls.insertInstructor(et1.getText().toString(),et2.getText().toString(),et3.getText().toString(),
                        et4.getText().toString(),depId).enqueue(new Callback<ResponseBody>() {
                    @Override
                ...
                /*FragmentTransaction transection = ((signup2) getActivity()).manager.beginTransaction();
                code codefragment = new code();

                transection.replace(R.id.frame, codefragment);
                transection.commit();
